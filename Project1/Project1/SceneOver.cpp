...
void CSceneOver::InitScene()
{
	...
	//SE情報の登録
	Audio::LoadAudio(0, L"素材/BGM/GameOver.wav", SOUND_TYPE::BACK_MUSIC);
	...
	Draw::LoadImageW(L"素材/仮/選択.png", 2, TEX_SIZE_1024);
	Draw::LoadImageW(L"素材/画像/ゲームオーバー(仮).png", 1, TEX_SIZE_1024);
	Draw::LoadImageW(L"素材/画像/ゲームオーバー.png", 4, TEX_SIZE_1024);
	Audio::Start(0);
