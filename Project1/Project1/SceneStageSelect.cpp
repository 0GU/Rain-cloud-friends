...
void CSceneStageSelect::InitScene()
{
	...
	//画像情報を登録
	Draw::LoadImageW(L"素材/仮/Stage背景仮.png", 0, TEX_SIZE_2048);
	Draw::LoadImageW(L"素材/仮/TestStage.png", 1, TEX_SIZE_1024);
	Draw::LoadImageW(L"素材/仮/Animation.png", 2, TEX_SIZE_1024);
